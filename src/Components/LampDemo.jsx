  ...
  return (
    <LampContainer>
      <motion.h1
        ...
        className="mt-8 bg-gradient-to-br from-slate-300 to-slate-500 py-4 bg-clip-text text-center text-4xl font-medium tracking-tight text-transparent md:text-4xl sm:text-xl">
        Sir Isaac Newton was a renowned English mathematician, physicist, astronomer, and philosopher, widely recognized as one of the most influential scientists in history. Born in 1643, he made groundbreaking contributions to many fields of science, most notably through his formulation of the laws of motion and universal gravitation. 
      </motion.h1>
    </LampContainer>
  );
}
...
export const LampContainer = ({
  ...
  return (
    <div
      className={cn(
        "relative flex h-full flex-col items-center justify-center overflow-hidden bg-transparent w-full sm:pt-36  rounded-md z-0",
        className
      )}>
      <div
        ...
        <motion.div
          ...
          className="absolute inset-auto right-1/2 h-56 overflow-visible w-[30rem] bg-gradient-conic from-[#ce09d3] via-transparent to-transparent text-white [--conic-position:from_70deg_at_center_top]">
          <div
